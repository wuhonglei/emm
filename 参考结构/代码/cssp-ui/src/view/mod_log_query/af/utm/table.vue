<template>
    <div class="utm-table-wrapper log-table-wrap">
        <div class="table">
            <el-table
                ...
                <el-table-column
                    ...
                    show-overflow-tooltip />
                <el-table-column
                    v-if="columnShows.dst_ip_belong"
                    label="目的IP归属地"
                    prop="dst_ip_belong"
                    min-width="100px"
                    show-overflow-tooltip />
...
export default {
    ...
    methods: {
        ...
        resolveParams (preload = 0) {
            ...
            return logParamsHelper(this.storeParams, rules, 'af', 'utm', controlPara, this.storeLoadedData);
        },

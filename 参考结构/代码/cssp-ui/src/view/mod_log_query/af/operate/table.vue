<template>
    <div class="operate-table-wrapper log-table-wrap">
        <div class="table">
            <el-table
                ...
                <el-table-column
                    v-if="columnShows.user_addr"
                    label="主机IP"
                    prop="user_addr"
                    min-width="100px"
                    show-overflow-tooltip />
                <el-table-column
                    v-if="columnShows.opr_obj_id"
                    label="操作对象"
                    prop="opr_obj_id"
                    min-width="150px"
                    show-overflow-tooltip />
                <el-table-column
                    v-if="columnShows.opr_obj_type"
                    label="操作"
                    prop="opr_obj_type"
                    min-width="50px"
                    show-overflow-tooltip />
...
export default {
    ...
    methods: {
        ...
        resolveParams (preload = 0) {
            ...
            return logParamsHelper(this.storeParams, rules, 'af', 'operate', controlPara);
        },

<template lang="pug">
.ac-chat-table-wrapper.log-table-wrap
    .table
        el-table(:data="tableData"
            ...
            el-table-column(label="发送账号"
                v-if="columnShows.chat_from"
                prop="chat_from"
                min-width="100"
                show-overflow-tooltip)

            el-table-column(label="接收账号"
                v-if="columnShows.chat_to"
                prop="chat_to"
                min-width="100"
                show-overflow-tooltip)

            el-table-column(label="聊天摘要"
                v-if="columnShows.msg"
                prop="msg"
                min-width="140"
                show-overflow-tooltip)

            el-table-column(label="聊天工具"
...
export default {
    ...
    methods: {
        ...
        resolveParams (preload = 0) {
            ...
            return logParamsHelper(this.storeParams, rules, 'ac', 'chat', controlPara);
        },

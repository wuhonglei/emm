<template lang="pug">
.ac-web-table-wrapper.log-table-wrap
    .table
        el-table(:data="tableData"
            ...
            el-table-column(label="标题"
                v-if="columnShows.title"
                prop="title" 
                min-width="100"
                show-overflow-tooltip)

            el-table-column(label="访问域名"
                v-if="columnShows.host"
                prop="host"
                min-width="90"
                show-overflow-tooltip)
...
export default {
    ...
    methods: {
        ...
        resolveParams (preload = 0) {
            ...
            return logParamsHelper(this.storeParams, rules, 'ac', 'web', controlPara);
        },

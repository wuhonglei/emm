...
.ac-behavior-bbs-wapper.query
    ...
    el-form(v-model="formValid"
        ...
        .query__content
            ...
            .form
                .form__label {{QUERY_NAME.postType}}
                .form__content
                    el-checkbox-group(v-model="params.postType" :min="1")
                        el-checkbox(label="发帖") 发帖
                        el-checkbox(label="微博") 微博
                        el-checkbox(label="其他POST") 其他POST

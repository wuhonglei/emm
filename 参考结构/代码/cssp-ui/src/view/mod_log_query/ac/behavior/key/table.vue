<template lang="pug">
.ac-key-table-wrapper.log-table-wrap
    .table
        el-table(:data="tableData"
            ...
            el-table-column(label="搜索关键字"
                v-if="columnShows.keyword_original"
                prop="keyword_original"
                show-overflow-tooltip)
...
export default {
    ...
    methods: {
        ...
        resolveParams (preload = 0) {
            ...
            return logParamsHelper(this.storeParams, rules, 'ac', 'key', controlPara);
        },

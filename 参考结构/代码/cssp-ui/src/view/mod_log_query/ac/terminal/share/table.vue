<template lang="pug">
.ac-share-table-wrapper.log-table-wrap
    .table
        el-table(:data="tableData"
            ...
            el-table-column(label="共享终端数"
                v-if="columnShows.prcnt"
                prop="prcnt"
                show-overflow-tooltip)
...
export default {
    ...
    methods: {
        ...
        resolveParams (preload = 0) {
            ...
            return logParamsHelper(this.storeParams, rules, 'ac', 'share', controlPara);
        },

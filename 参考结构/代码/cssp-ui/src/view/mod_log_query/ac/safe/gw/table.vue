<template lang="pug">
.ac-gw-table-wrapper.log-table-wrap
    .table
        el-table(:data="tableData"
            ...
            el-table-column(label="用户名" v-if="columnShows.user_name" prop="user_name" min-width="150px" show-overflow-tooltip)
            el-table-column(label="组名" v-if="columnShows.grp_name" prop="grp_name" min-width="150px" show-overflow-tooltip)
            el-table-column(label="源IP" v-if="columnShows.src_ip" prop="src_ip" min-width="150px" show-overflow-tooltip)
            el-table-column(label="终端类型" v-if="columnShows.tm_name" prop="tm_name" min-width="150px" show-overflow-tooltip)
            el-table-column(label="位置" v-if="columnShows.site_name" prop="site_name" min-width="150px" show-overflow-tooltip)
            el-table-column(label="应用类型" v-if="columnShows.serv_name" prop="serv_name" min-width="150px" show-overflow-tooltip)
            el-table-column(label="应用名称" v-if="columnShows.app_name" prop="app_name" min-width="150px" show-overflow-tooltip)
            el-table-column(label="病毒名称" v-if="columnShows.virus" prop="virus" min-width="150px" show-overflow-tooltip)
            el-table-column(label="访问控制" v-if="columnShows.net_action" prop="net_action" min-width="150px" show-overflow-tooltip)
...
export default {
    ...
    methods: {
        ...
        resolveParams (preload = 0) {
            ...
            return logParamsHelper(this.storeParams, rules, 'ac', 'virus', controlPara);
        },

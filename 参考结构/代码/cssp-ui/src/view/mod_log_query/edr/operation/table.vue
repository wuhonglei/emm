<template>
    <div class="operation-table-wrapper log-table-wrap">
        <div class="table">
            <el-table
...
let loadEdrOperationLog = normalizeParams(loadLog, 'edr', 'operate', []);
let loadEdrOperationPage = normalizeParams(loadPage, 'edr', 'operate', []);
let loadEdrOperationExport = normalizeParams(loadExport, 'edr', 'operate', []);
...
export default {
    ...
    methods: {
        ...
        loadData () {
            ...
            let search = this.useLogSearch ? loadEdrOperationLog : loadEdrOperationPage;
        ...
        preLoad () {
            ...
            loadEdrOperationLog(controlPara, sortPara)
                .then(({data}) => {
        ...
        export () {
            ...
            loadEdrOperationExport(controlPara, sortPara)
                .then(({data}) => {

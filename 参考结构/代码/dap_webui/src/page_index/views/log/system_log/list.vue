<template>
    <div class="system-log-list-wrapper h-100">
        <div v-show="toggle" 
        ...
        <div class="log-manage__table"
            ...
            <table-page
                ...
                <sf-table-column
                    ...
                    <template 
                        slot-scope="scope">
                        <span :class="'log-manage__' + scope.record.logLevel">
                            {{ scope.record.logLevel_transfer }}
                        </span>
                    </template>
                </sf-table-column>
                <sf-table-column
    ...
    methods: {
        ...
        loadData () {
            getLogSearchKeys({
                ...
                this.logLevel = lodashGet(paramsData, 'logLevel.values', []);
                this.source = lodashGet(paramsData, 'module.values', []);
        ...
        updateConditionTag () {
            ...
            this.conditionTags.push({
                ...
                label: '来源：' + this.handleSelect(this.source, params.module), value: 'module', closeable: true  
            }, {
                label: '日志等级：' + this.handleSelect(this.logLevel, params.logLevel), value: 'logLevel', closeable: true  
            });

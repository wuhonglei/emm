<template>
    <div class="user-log-list-wrapper h-100">
        <div v-show="toggle"
        ...
        <div class="log-manage__table"
            ...
            <table-page
                ...
                <sf-table-column
                    :toggle-column="true"
                    data-index="authMethods_transfer">
                    认证方式
                </sf-table-column>
                <sf-table-column
                    :toggle-column="true"
        ...
        <see-details
            ...
            <div slot="seeDetailsList">
                ...
                <div class="see-details__item">
                    <label class="see-details__label"><lang>用户组：</lang></label>
                    <div class="see-details__content">
                        {{ detailData.groupPath }}
                    </div>
                </div>
                <div class="see-details__item">
                ...
                <div class="see-details__item">
                    <label class="see-details__label"><lang>虚拟IP：</lang></label>
                    <div class="see-details__content">
                        {{ detailData.vip }}
                    </div>
                </div>
                <div class="see-details__item">
                    <label class="see-details__label"><lang>资源IP：</lang></label>
                    <div class="see-details__content">
                        {{ detailData.rcip }}
                    </div>
                </div>
                <div class="see-details__item">
                    <label class="see-details__label"><lang>终端类型：</lang></label>
                    <div class="see-details__content">
                        {{ detailData.osType_transfer }}
                    </div>
                </div>
                <div class="see-details__item">
                    <label class="see-details__label"><lang>MAC地址：</lang></label>
                    <div class="see-details__content">
                        {{ detailData.macAddr }}
                    </div>
                </div>
                <div class="see-details__item">
                    <label class="see-details__label"><lang>认证方式：</lang></label>
                    <div class="see-details__content">
                        {{ detailData.authMethods_transfer }}
                    </div>
                </div>
                <div class="see-details__item">
        ...
        <iframe
            v-show="false" 
            name="userIframeCsv"></iframe>  
        <form
            v-show="false"
            ref="userIframeCsv"
            target="userIframeCsv"
            method="get"
    ...
    methods: {
        ...
        loadData () {
            getLogSearchKeys({
                ...
                this.osType = lodashGet(paramsData, 'osType.values', []);
        ...
        openExportModal (progressValue) { 
            ...
            // 下载ZIP
            this.$refs.userIframeCsv.submit();
        ...
        updateConditionTag () {
            ...
            this.conditionTags.push({
                ...
                label: '终端类型：' + this.handleSelect(this.osType, params.osType), value: 'osType', closeable: true  
            }, {
